...
n = 3 # Tenemos que definir la n porque no está definida en el pdf y si no da error
...
# A partir de aquí diseñamos varios tests unitarios para comprobar su correcta funcionalidad:
...
# Método para ver si un nuevo movimiento de un jugador le permite ganar el juego
...
# Sobre este método definimos dos tests unitarios diferentes
...
# En este punto vamos a añadir la lógica del juego que permita hacerlo interactivo. En primer lugar
# mplementamos el método que permita mostrar el estado actual del tablero por pantalla:
